        ...
        <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm'>
            ...
            <div>
                ...
                <ul className='flex flex-col gap-1 text-gray-600'>
                    ...
                    <li>contact.rewear@info.com</li>
                </ul>
            </div>
        </div>
        <div>
            <hr />
            <p className='py-5 text-sm text-center'>Copyright &copy;2025 ReWear. All rights reserved.</p>
        </div>
    </div>
  )
}
