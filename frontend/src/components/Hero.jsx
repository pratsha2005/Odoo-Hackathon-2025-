        ...
        <div className='flex items-center justify-center w-full py-10 sm:w-1/2 sm:py-0'>
            <div className='text-[#414141]'>
                <div className='flex items-center gap-2'>
                    ...
                    <p className='text-sm font-medium md:text-base'>SWAP, DON'T SHOP</p>
                </div>
                <h1 className='text-3xl leading-relaxed sm:py-3 lg:text-5xl prata-regular'>Exchange Your Clothes, Refresh Your Style</h1>
                <div className='flex items-center gap-2'>
